...
const Footer = () => {
  return (
    <footer className="bg-stone-950 text-stone-300 pt-12 md:pt-16 pb-8 border-t border-stone-800/80 relative overflow-hidden">
      
      {/* Background Subtle Ambient Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-24 bg-amber-500/5 blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 relative z-10">
        ...
        <div>
          <h4 className="text-stone-100 text-xs font-semibold tracking-widest uppercase mb-3.5 font-serif">
            Navigation
          </h4>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <a
              ...
              className="flex items-center gap-3 bg-stone-900/80 border border-stone-800 hover:border-amber-900/50 text-stone-200 hover:text-white px-3.5 py-2 rounded-xl text-xs font-medium transition-all group active:scale-98"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-10 pt-6 border-t border-stone-900 flex flex-col sm:flex-row justify-between items-center text-[11px] text-stone-500 font-light gap-3 text-center sm:text-left">
